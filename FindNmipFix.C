...
void FindNmipFix(int day=185){
  ...
  std::ofstream NmipFile(Form(
    "/mnt/d/9_2GeV/NmipConstantsDay%d.txt",day),ofstream::out);
  ...
  theCanvas->SaveAs(
        Form("/mnt/d/IsobarRedo/ADCspectraDay%d.pdf[",day));
